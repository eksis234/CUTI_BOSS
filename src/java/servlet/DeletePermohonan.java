 ...
 * @author Lenovo
 */
@WebServlet(name = "DeletePermohonan", urlPatterns = {"/deletePermohonan"})
public class DeletePermohonan extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if(ic.delete(permohonan))message = "Sukses Delete";
