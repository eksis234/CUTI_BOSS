                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Data Table Departemen</strong>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <% List<Departemen> datas = (List<Departemen>) session.getAttribute("DataDepartemen");
                            int i = 0;
                            for (Departemen departemen : datas) {%>
                    <tr>
                        <td><%=  departemen.getIdDepartemen() %></td>
                        <td><%= departemen.getNamaDepartemen() %></td>
                        <td><div class="fa-hover col-lg-3 col-md-6"><a href="updOrSaveDepartemen?id=<%= departemen.getIdDepartemen() %>"><i class="fa fa-edit"></i></a></div>
                            <div class="fa-hover col-lg-3 col-md-6"><a href="deleteDepartemen?id=<%= departemen.getIdDepartemen() %>"><i class="fa fa-trash-o"></i></a></div>
                        </td>
                    </tr>
                    <%
                        }
