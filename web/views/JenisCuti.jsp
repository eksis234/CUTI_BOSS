                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Data Table Jenis Cuti</strong>
                        </div>
                        <div class="card-body">
                  <table id="bootstrap-data-table" class="table table-striped table-bordered">
                    ...
                    <tbody>
                        <% List<JenisCuti> datas = (List<JenisCuti>) session.getAttribute("DataJenisCuti");
                            ...
                            out.println(message);
                            int i = 0;
                            for (JenisCuti jc : datas) {%>
                    <tr>
                        <td><%= jc.getIdCuti() %></td>
                        <td><%= jc.getNamaCuti() %></td>
                        <td><%= jc.getDeskripsi() %></td>
                        <td><%= jc.getLamaCuti() %></td>
                        <td><div class="fa-hover col-lg-3 col-md-6"><a href="updOrSaveJenisCuti?id=<%= jc.getIdCuti() %>"><i class="fa fa-edit"></i></a></div>
                            <div class="fa-hover col-lg-3 col-md-6"><a href="deleteJenisCuti?id=<%= jc.getIdCuti() %>"><i class="fa fa-trash-o"></i></a></div>
                        </td>
                    </tr>
                <%
                    }
